...
output_path = os.path.join(target_dir, "station_forecast34.tex")
...
stations_chunk_2 = {k: stations[k] for k in list(stations)[4:8]}
stations_chunk_3 = {k: stations[k] for k in list(stations)[8:]}
...
latex_content += add_station_frame(stations_chunk_3)

# Save the LaTeX content to a file without the preamble
