...
\begin{minipage}[t]{0.6\textwidth} % Right minipage taking 48% of the width
    \textbf{\large SATELLITE-BASED GLANCE INTO THIS MORNING, TUESDAY 17 DECEMBER 2024} \\[0.3cm]
...
\noindent
\textcolor{white}{\colorbox{headerblue}{\parbox{\textwidth}{\centering \Large \textbf{WEATHER FORECAST: WEDNESDAY 18 DECEMBER 2024}}}}
