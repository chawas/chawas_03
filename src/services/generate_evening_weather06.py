...
#from src.services.station_images.extract_forecast29 import output_path
...
def generate_latex_with_dates(target_dir):
    ...
    output_path = os.path.join(target_dir, "dynamic_weather_forecast18.tex")
...
#latex_file = "dynamic_weather_forecast18.tex"
latex_file = output_path
