    ...
    \begin{columns}[T] % Align columns at the top
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{center}
                ...
                \textbf{Infrared Radiation} (Data from: November 28, 2024 06:00Z) % Title
            \end{center}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{center}
                ...
                \vspace{-1cm} % Move image up closer to the title
                \textbf{Water Vapour} (Data from: November 28, 2024 00:00Z) % Title
            \end{center}
        \end{column}
    \end{columns}
    ...
    \begin{columns}[T] % Second row with Tomorrow images
        ...
        \begin{column}{0.48\textwidth}
            \begin{center}
                ...
                \textbf{Infrared Radiation} (Data for: November 30, 2024 06:00Z) % Title
            \end{center}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            \begin{center}
                ...
                \vspace{-0.5cm} % Reduce space between image and title
                \textbf{Water Vapour} (Data for: November 30, 2024 00:00Z) % Title
            \end{center}
        \end{column}
    \end{columns}
